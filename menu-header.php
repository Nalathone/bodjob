...
?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
      id="navbarDropdownMenuLink-333" data-toggle="dropdown" href="#"
      ...
      <div class="dropdown-menu dropdown-menu-right dropdown-default"
        ...
        <a class="dropdown-item">ຂໍ້ມູນຜູ້ໃຊ້</a>  
          <a class="dropdown-item"
          data-toggle="modal" data-target="#modal-ChangePass" href="#">ປ່ຽນລະຫັດຜ່ານ</a>
      </div></li>
  </ul>
    </ul>
  </nav>
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  <input type="password" class="form-control"
                    name="txtCurpassword" id="txtCurpassword"
                    onfocusout="CheckOldPass(<?=$Get_OLDPASS?>);"
                    required="required">
                  <div class="input-group-append">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  <input type="password" class="form-control"
                    name="txtNewpassword" id="txtNewpassword"
                    onfocusout="CompairPass();" required="required">
                  <div class="input-group-append">
                    <div class="input-group-text">
                      <span class="fas fa-lock"></span>
                    </div>
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  <input type="password" class="form-control"
                    name="txtConpassword" id="txtConpassword"
                    onfocusout="CompairPass();" onkeyup="CompairPass2();"
                    required="required">
                  <div class="input-group-append">
                    <div class="input-group-text">
                      <span class="fas fa-lock"></span>
